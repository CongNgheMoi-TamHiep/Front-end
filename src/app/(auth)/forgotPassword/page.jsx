...
import { RecaptchaVerifier, signInWithPhoneNumber, EmailAuthProvider, linkWithCredential, PhoneAuthProvider, signInWithCredential, updatePassword } from "firebase/auth";
import "./styles.scss";
...
export default function SignUp() {
    ...
    const [conrfirmPassword, setConrfirmPassword] = useState("");
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        {userCr &&  <Grid item xs={12}>
                                            <TextField
                                                ...
                                                label="conrfirm password"
                                                type="password"
                                                id="conrfirmPassword"
                                                autoComplete="new-password"
                                                value={conrfirmPassword}
                                                onChange={(e)=>setConrfirmPassword(e.target.value)}
                                            />
                                        </Grid>}
                                    </Grid>
                                    <Button
